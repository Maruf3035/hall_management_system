...
$someData = $objBooking->cancel_approve();
    ...
    <form method="post">
        <div class="container-fluid tableBackground wow slideInUp forTopMargin">
            ...
            <div class="table-responsive">
                <h1 class="wow fadeInDown" style="text-align: center">Pending hall Booking List </h1>
                <hr>
        ...
        <!--    <td> $serial</td>-->
                ...
                <td>
                    ...
                    <a href='delete.php?booking_id=$oneData->booking_id' class='btn btn-block btn-primary'> Approve cancel  </a>
