...
<div class="container-fluid tableBackground wow slideInUp forTopMargin">
    ...
    <div class="table-responsive">
        <h1 class="wow fadeInDown" style="text-align: center">Approved Invoice list</h1><hr>
...
<td>
                    <a href='admin_view_invoice.php?booking_id=$oneData->booking_id' class='btn btn-block btn-success'> Invoice </a>

                     <a href='tel:$oneData->phone_number' class='btn btn-block btn-info'>Call</a>
                </td>
     </tr>
            ";
        $serial++;
