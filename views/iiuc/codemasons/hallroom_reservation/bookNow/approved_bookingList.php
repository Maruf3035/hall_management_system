    ...
    <form method="post">
        <div class="container-fluid tableBackground wow slideInUp forTopMargin">
            ...
            <div class="table-responsive">
                <h1 class="wow fadeInDown" style="text-align: center">Approved Booking List </h1>
                <hr>
        ...
        <!--    <td> $serial</td>-->
                ...
                <td>
                    <a href='single_view_booking_list.php?booking_id=$oneData->booking_id' class='btn btn-block btn-success'> View  </a>
<!--
                    <a href='approved_booking_list.php' class='btn btn-block btn-primary'> Approve  </a>
-->
                    <a href='delete.php?booking_id=$oneData->booking_id' class='btn btn-block btn-danger'> Delete  </a>
