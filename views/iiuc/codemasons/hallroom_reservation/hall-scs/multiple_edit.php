...
?>
  ...
  <?php echo "<div style='height: 30px; text-align: center'> <div class='alert-success ' id='message'> $msg </div> </div>"; ?>
    <div class="table-responsive">
        <h3 style="text-align: center;padding-top: 15px;"> Convention Hall List (<?php echo count($allRecord) ?>) </h3> <hr>
        <table class="table table-bordered table-hover">
            ...
            <tr class='text-center'>
                ...
                <td>
                    ...
                    <a href='trash.php?hall_id=$oneData->hall_id' class='btn btn-block btn-warning'> Soft Delete</a>
